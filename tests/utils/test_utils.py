...
from pydcf.utils import _set_unitytime, _validate_timeseries
...
def test__set_unitytime(test_ts1, test_ts2):
...
def test__validate_timeseries(test_ts1):
    ...
    assert array_equality_test_helper(_validate_timeseries(test_ts1), test_ts1)
    assert array_equality_test_helper(_validate_timeseries(test_ts_2_col), expected_test_ts_2_col)
